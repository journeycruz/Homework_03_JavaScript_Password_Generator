...
    var charTypeConfirmLC = confirm("Would you like to include lowercase letters in your password?");
    var charTypeConfirmUC = confirm("Include uppercase letters?");
...
        // define string for password 
        passwordString = "";
        passwordStringLength = passwordString.length
        console.log(passwordStringLength);
        console.log(passwordLength);
        // add to passwordString from character set at random position while loop number <= password length
